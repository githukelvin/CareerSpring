...
<div>
    <div class="flex flex-col gap-3">
        <h1 class="font-[semibold] text-base text-black-200 text-sm">Attachment Details Form</h1>
        <p>Please fill in the form below to le us know where you are attached</p>
    </div>
    <form class="flex flex-col gap-5 py-3" action="" method="post">
        <div class=" flex flex-col gap-5">
            <div >
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-row gap-3 w-7/12">
                        <InputLabel for="regNo" value="Registration Number:"/>
                    ...
                    <div class="flex flex-row gap-3 w-7/12">
                        ...
                        <InputError :message="form.errors.schoolEmail" class="mt-2"/>
                    </div>
                    <div class="flex flex-row gap-3 w-7/12">
                        ...
                        <InputError :message="form.errors.phoneNo" class="mt-2"/>
                    </div>
            ...
            <div>
                <h1 class="font-[semibold] text-sm text-black-200 py-2">Academic Information</h1>
                <div class="flex flex-col gap-3">
                    <div class="flex flex-row gap-3 w-7/12">
                    ...
                    <div class="flex flex-row gap-3 w-7/12">
                        <InputLabel for="yearOfStudy" value="Year of Study:"/>
                        ...
                        <InputError :message="form.errors.yearOfStudy" class="mt-2"/>
                    </div>
            ...
            <div >
                <h1 class="font-[semibold] text-sm text-black-200 py-2">Attachment Details</h1>
                <div class="flex flex-col gap-3">
                    <div class="flex flex-row gap-3 w-7/12">
                    ...
                    <div class="flex flex-row gap-3 w-7/12">
                        <InputLabel for="attachmentPosition" value="Attachment position:"/>

                        <TextInput
                            id="attachmentPosition"
                            v-model="form.attachmentPosition"
                            autocomplete="attachmentPosition"
                            autofocus
                            class="mt-1 block w-full"
                            required
                            type="text"
                        ...
                        <InputError :message="form.errors.attachmentPosition" class="mt-2"/>
                    </div>
                    <div class="flex flex-row gap-3 w-7/12">
